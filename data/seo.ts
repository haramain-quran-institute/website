...
export const routeSeo: Record<string, RouteSeo> = {
  ...
  "/resources/tajweede-quran": {
    title: "Free Tajweed Quran Resources | Haramain",
    description: "Browse upcoming free Tajweed Quran resources for rule recognition, recitation practice, daily revision, and Quran reading progress.",
    primaryIntent: "free Tajweed Quran resources",
    secondaryIntents: ["Tajweed learning resources", "Quran recitation workbook", "Tajweed rules"],
  },
  "/resources/tajweede-qaida": {
    title: "Free Tajweede Qaida Resources | Haramain",
    description: "Explore upcoming free Tajweede Qaida learning resources for Arabic letters, joining, Makharij, pronunciation practice, beginner lessons, and parent-supported revision.",
    primaryIntent: "free Tajweede Qaida resources",
    secondaryIntents: ["Noorani Qaida learning resources", "Makharij practice guide", "Qaida for beginners"],
  },
  "/resources/namaz-book": {
    title: "Free Namaz & Salah Guides | Haramain",
    description: "Explore upcoming free Namaz and Salah guides covering Wudu, prayer steps, children's learning, daily worship, and consistent prayer habits.",
    primaryIntent: "Namaz and Salah guide",
    secondaryIntents: ["how to pray Salah", "Wudu and Salah guide", "Salah guide for children"],
  },
  "/resources/kalma-book": {
    title: "Free Six Kalmas Books & Guides | Haramain",
    description: "Study upcoming free six Kalmas guides covering Arabic text, meaning, pronunciation, faith foundations, and memorization practice.",
    primaryIntent: "six Kalmas book",
    secondaryIntents: ["Kalma guide for children", "Kalma memorization", "Islamic faith resources"],
  },
  "/resources/downloads": {
    title: "Free Islamic Books & Downloads | Haramain",
    description: "Browse upcoming free Islamic books and study guides about Seerah, the Sahaba, stories of the Prophets, daily duas, and practical Islamic guidance.",
    primaryIntent: "Islamic books and free downloads",
    secondaryIntents: ["Seerah book", "stories of the Sahaba", "Islamic duas guide"],
  },
  "/our-sessions": {
