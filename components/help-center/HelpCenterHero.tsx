...
export default function HelpCenterHero() {
  return (
    <section className="relative flex min-h-[650px] items-end overflow-hidden pb-20 pt-40 text-white min-[768px]:min-h-[720px] min-[1024px]:pb-24">
      <Image
        src={heroImage}
        alt="Haramain Quran Institute learner support"
        fill
        priority
        sizes="100vw"
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="mt-5 font-heading text-5xl font-semibold leading-[0.98] text-white sm:text-6xl min-[1024px]:text-[78px]">
            Help Center
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-x-7 gap-y-3 text-sm text-white/80">
            <span className="inline-flex items-center gap-2">
              <Headphones className="size-4 text-[#D0A86C]" /> Personal support
            </span>
            <span className="inline-flex items-center gap-2">
              <Globe2 className="size-4 text-[#D0A86C]" /> Three regional branches
            </span>
            <span className="inline-flex items-center gap-2">
              <Clock3 className="size-4 text-[#D0A86C]" /> Worldwide learners
            </span>
          </div>
