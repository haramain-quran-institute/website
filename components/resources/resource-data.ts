...
export const resourcePages: ResourcePageConfig[] = [
  {
    ...
    resources: [
      ...
      { title: "Essential Tajweed Rules Reference", description: "A concise reference for Noon Sakinah, Meem Sakinah, Madd, and stops.", filename: "tajweed-rules-reference.pdf", kind: "free", pages: 1 },
      ...
      { title: "Quran Reading Progress Journal", description: "Track weekly reading goals, corrections, reflections, and next steps.", filename: "quran-reading-progress-journal.pdf", kind: "free", pages: 1 },
    ],
  },
  {
    ...
    resources: [
      ...
      { title: "Makharij Practice Guide", description: "Practise articulation points through clear letter-pair exercises.", filename: "makharij-practice-guide.pdf", kind: "free", pages: 1 },
      { title: "Qaida Lesson Workbook", description: "Review each lesson with reading exercises and progress checks.", filename: "qaida-lesson-workbook.pdf", kind: "free", pages: 1 },
  ...
  },
  {
    ...
    resources: [
      { title: "Complete Namaz Guide", description: "Understand preparation, prayer movements, recitation, and consistency.", filename: "complete-namaz-guide.pdf", kind: "free", pages: 1 },
      ...
      { title: "Daily Prayer Tracker", description: "Build a gentle, consistent five-prayer habit with weekly reflection.", filename: "daily-prayer-tracker.pdf", kind: "free", pages: 1 },
    ],
  },
  {
    ...
    resources: [
      ...
      { title: "Kalma and Foundations of Faith", description: "Connect the testimony of faith with essential Muslim beliefs.", filename: "faith-foundations.pdf", kind: "free", pages: 1 },
      { title: "Kalma Memorization Workbook", description: "Use weekly targets, revision checks, meaning, and reflection.", filename: "kalma-memorization-workbook.pdf", kind: "free", pages: 1 },
    ],
  },
  {
    ...
    resources: [
      { title: "A Concise Seerah Guide", description: "Explore the Prophet's life, perseverance, and lessons for character.", filename: "seerah-book.pdf", kind: "free", pages: 1 },
      { title: "Stories of the Sahaba", description: "Learn from examples of courage, sincerity, generosity, and service.", filename: "stories-of-sahaba.pdf", kind: "free", pages: 1 },
      { title: "Stories of the Prophets", description: "Reflect on faith through trials, trust in Allah, and timeless lessons.", filename: "stories-of-prophets.pdf", kind: "free", pages: 1 },
