...
import heroImage from "@/assets/gallery-3.jpg";
...
export default function FreeCoursesHero() {
  return (
    <section className="relative flex min-h-[650px] items-end overflow-hidden pb-20 pt-40 text-white min-[768px]:min-h-[720px] min-[1024px]:pb-24">
      <Image src={heroImage} alt="Free Islamic learning courses at Haramain Quran Institute" fill priority sizes="100vw" className="object-cover" />
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="mt-8 flex flex-wrap gap-x-7 gap-y-3 text-sm text-white/80">
            ...
            <span className="inline-flex items-center gap-2"><BookOpenCheck className="size-4 text-[#D0A86C]" /> Practical Islamic learning</span>
            <span className="inline-flex items-center gap-2"><UsersRound className="size-4 text-[#D0A86C]" /> Open to all learners</span>
          </div>
          <div className="mt-10">
