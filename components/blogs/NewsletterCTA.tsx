...
import { sendNewsletterSubscription } from "./actions/sendNewsletterSubscription";
...
export default function NewsletterCTA() {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    else setError(result.error || "Unable to complete your subscription.");
  };
      ...
      <div className="container">
        <div className="relative overflow-hidden rounded-[8px] bg-[#071F1B] px-6 py-16 text-center sm:px-10 sm:py-20">
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            <p className="mt-5 font-body text-xs font-bold uppercase tracking-[0.2em] text-[#D0A86C]">Newsletter</p>
