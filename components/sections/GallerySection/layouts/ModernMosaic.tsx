...
export default function ModernMosaic({
  ...
  return (
    <div className="grid h-full w-full grid-cols-6 grid-rows-2 gap-4 md:gap-5">
      {/* Top Left */}
      <div className="relative col-span-2 row-span-1 min-h-0 overflow-hidden rounded-[var(--radius-md)]">
      ...
      {/* Bottom Left */}
      <div className="relative col-span-3 row-span-1 min-h-0 overflow-hidden rounded-[var(--radius-md)]">
