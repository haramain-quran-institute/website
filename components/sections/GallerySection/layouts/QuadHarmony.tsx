...
export default function QuadHarmony({
  ...
  return (
    <div className="grid size-full grid-cols-12 grid-rows-12 gap-4 md:gap-6">
      <div className="relative col-span-6 row-span-5 overflow-hidden rounded-[var(--radius-md)]">
        <MediaRenderer item={media[0]} index={0} onOpen={onOpen} />
      </div>

      <div className="relative col-span-6 row-span-7 overflow-hidden rounded-[var(--radius-md)]">
