...
export default function ClassicAsymmetric({
  ...
  return (
    <div className="grid size-full grid-cols-12 gap-4 md:gap-6">
      <div className="relative col-span-6 row-span-2 overflow-hidden rounded-[var(--radius-md)] md:col-span-4">
        <MediaRenderer item={media[0]} index={0} onOpen={onOpen} />
      </div>

      <div className="relative col-span-6 overflow-hidden rounded-[var(--radius-md)] md:col-span-4">
      ...
      <div className="relative col-span-3 overflow-hidden rounded-[var(--radius-md)] md:col-span-2">
