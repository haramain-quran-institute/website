...
export default function BookTrialHero() {
  return <section className="relative flex min-h-[650px] items-end overflow-hidden pb-20 pt-40 text-white min-[768px]:min-h-[720px] min-[1024px]:pb-24">
    <Image src={heroImage} alt="Book a personal online Quran trial class" fill priority sizes="100vw" className="object-cover" />
    ...
    <div className="container relative z-10"><div className="max-w-4xl">
      <p className="font-body text-sm font-semibold uppercase tracking-[0.2em] text-[#D0A86C]">Start Your Learning Journey</p>
