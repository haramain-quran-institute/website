...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en" data-scroll-behavior="smooth" className={`${bricolage.variable} ${libre.variable} ${inter.variable}`}><body className={inter.className}><FormProvider>{children}<FloatingChatButton /></FormProvider></body></html>; }
